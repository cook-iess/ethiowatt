...
<body class="bg-BrownLight w-full text-BrownDark font-TextFont">
      <div class="md:w-3/4 w-full font-sans fixed top-0 z-50 md:bg-transparent bg-BrownLight">
        <div class="flex justify-between w-full md:py-6 md:px-10 py-2 px-4 mt-3 md:mt-0">
          ...
          <div class="my-auto flex">
            <a href="signup.php" 
            class="rounded-lg md:mr-4 md:text-base text-sm mr-3 ml-1 md:ml-0 bg-BrownDark font-TextFont text-BrownLight hover:font-extrabold font-bold md:py-3 md:px-5 py-2 px-3 shadow-xl hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-110">
            Sign up</a>
            <a href="login.php" 
            class="rounded-lg md:mr-4 md:text-base text-sm bg-BrownDark font-TextFont text-BrownLight hover:font-extrabold font-bold md:py-3 md:px-5 py-2 px-3 shadow-xl hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-110">
            Login</a>
          </div>
        </div>
      </div>
      ...
      <div class="md:grid grid-cols-2 my-auto w-full md:mt-0 mt-28">
        <div class="my-auto md:ml-14 ml-6 px-3 md:mb-auto mb-14">
          ...
          <p class="mt-1">The most appropriate book site to reach books</p>
        </div>
        <div class="relative w-full">
          ...
          <div class="relative z-10 md:h-screen w-full">
            <img
              src="img/book8.png"
              alt="Your Image"
              class="md:h-full md:w-full object-cover"
            />
          </div>
        </div>
      </div>
