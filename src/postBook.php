            ...
            if (isset($_POST["Agree"])) {
                ...
                if ($error === 0) {
                    ...
                    if (in_array($imageexlc, $allowedex)) {
                        ...
                        header("Location: postBook.php?error=notsupported&title=" . $title . "&desc=" . $desc . "&lang=" . $lang . "&genre=" . $genre . "&PG=" . $pg);
                        exit();
                    }
                }
                ...
                if ($yes) {
                    ...
                    header("Location: startWriting.php?error=failed&title=" . $title . "&desc=" . $desc . "&lang=" . $lang . "&genre=" . $genre . "&PG=" . $pg);
                    exit();
                }
            } else {
                header("Location: postBook.php?error=notaggreed&title=" . $title . "&desc=" . $desc . "&lang=" . $lang . "&genre=" . $genre . "&PG=" . $pg);
                exit();
            }
        } else {
            header("Location: postBook.php?error=emptyfields&title=" . $title . "&desc=" . $desc . "&lang=" . $lang . "&genre=" . $genre . "&PG=" . $pg);
            exit();
        }
    }
    ...
    <body class="bg-BrownLight w-full h-screen text-BrownDark font-TextFont">
        ...
        <div class="flex justify-center items-center h-screen mt-4">
            ...
            <div class="grid grid-cols-4">
                <div class="bg-BrownDark text-BrownLight align-middle my-auto shadow-2xl py-10">
                    <div class="">
                        <p class="text-4xl font-bold text-center mt-4">
                            Post Book
                        </p>
                    ...
                    <div class="">
                        <img src="img/signimg.png" class="mx-auto px-8 pb-4 w-96" />
                    </div>
                </div>

                <div class="bg-BrownLight text-BrownDark col-span-3">
                    <form action="postBook.php" class="ml-12 grid grid-cols-4 gap-x-6 gap-y-3 mr-12" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-span-4 row-span-2">
                            ...
                            <textarea name="desc" id="" cols="30" rows="6" placeholder="Brief description" class="block w-full shadow-lg appearance-none border bg-transparent rounded py-2 px-3 leading-tight focus:outline-none focus:shadow-outline placeholder-BrownDark2"></textarea>
                        </div>
                        ...
                        <div class="col-span-4">
                            ...
                            <p class="inline"> This is my original work, and I take full responsibility for any plagiarism. </p>
                        </div>
                        <div class="col-span-4">
                            <?php
                        ...
                        <div class="my-auto col-span-4 mx-auto">
