    ...
    <body class="bg-BrownLight w-full h-full text-BrownDark font-TextFont">
        ...
        <div class="flex justify-end md:mt-6 mt-2">
            <div class="grid grid-cols-2">
                <div class="my-auto">
                    <a href="chanpass.php" class="text-xs rounded-lg md:mr-1 bg-BrownDark font-TextFont text-BrownLight hover:font-extrabold font-bold md:py-3 py-2 px-2 shadow-xl md:text-sm hover:shadow-2xl">Change Password</a>
                </div>
                <div class="my-auto flex justify-end">
                    <a href="editprofile.php" class="text-xs rounded-lg mr-4 bg-BrownDark font-TextFont text-BrownLight hover:font-extrabold font-bold md:py-3 py-2 md:px-5 px-3 md:text-sm shadow-xl hover:shadow-2xl">Edit Profile</a>
                </div>
            </div>
        </div>
            ...
            ?>
                    <div class="grid md:grid-cols-4 grid-cols-2 gap-4 justify-around">
                        ...
                        <div class="my-auto md:col-span-2">
                            ...
                            <p class="md:text-base text-xs text-gray-600 md:text-center pt-3"><b>Joined: </b><?php echo $result['Reg_Date'] ?></p>
                        </div>
                    </div>
            <?php
                }
            ...
            <div class="flex justify-end md:mt-0 mt-10">
                <div class="grid grid-cols-2">
                    <div class="my-auto self-end flex justify-end">
                        <a href="logout.php" class="text-xs rounded-lg mr-3 bg-BrownDark font-TextFont text-BrownLight hover:font-extrabold font-bold md:py-3 py-2 md:px-5 px-3 md:text-sm shadow-xl hover:shadow-2xl">Logout</a>
                    </div>
                    <div class="my-auto">
                        <form action="ppuser.php" method="post">
                            <button type="submit" name="delete" class="text-xs rounded-lg mr-4 bg-BrownDark font-TextFont text-BrownLight hover:font-extrabold font-bold md:py-3 py-2 md:px-5 px-3 md:text-sm shadow-xl hover:shadow-2xl">
                                Delete
                            </button>
                        </form>
                    </div>
        ...
        <div>
            <p class="md:text-4xl font-TitleText font-bold text-BrownLight bg-BrownDark py-4 md:mt-8 mb-2 px-10 w-fit">Your favourites:</p>
        </div>
