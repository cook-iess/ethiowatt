...
?>
            ...
            <body class="bg-BrownLight w-full h-full text-BrownDark font-TextFont overflow-y-scroll custom-scrollbar">
                ...
                <div class="fixed-header bg-BrownDark3 text-BrownDark w-full fixed top-0 shadow">
                    ...
                    <a href="bookdetail.php?id=<?= $book_id ?>&lang=<?php echo $_GET['lang']; ?>" class="exit-btn bg-BrownDark2 hover:bg-BrownDark duration-300 md:px-4 px-3 md:py-2 py-1 md:rounded-xl rounded-md text-BrownDark3 shadow-2xl text-sm md:text-base"><?php echo $translations[$lang]['exit']; ?></a>
                </div>
