        ...
        <body class="bg-BrownLight w-full h-full text-BrownDark font-TextFont overflow-y-scroll custom-scrollbar">
            <div class="lg:text-xl text-BrownLight grid grid-cols-2 w-full md:mt-28 mt-16" >
                ...
                <div class="self-end flex justify-end md:col-span-1 col-span-2 md:mt-0 mt-2">
                    <a href="bookdetailadmin.php?id=<?= $book_id; ?>" class="rounded-lg md:mr-4 mr-2 bg-BrownDark font-TextFont text-BrownLight hover:font-extrabold font-bold md:py-4 py-2 px-4 shadow-xl hover:shadow-2xl">
                        Back</a>
                </div>
            </div>
                            ...
                            <div class="md:w-4/5 w-[90%] mx-auto">
                                ...
                                <div class="grid grid-cols-4 mb-4">
                                    <div class="col-span-3">
                                        <p class="md:text-xl text-lg"><i>Username: </i><a href="profileAd.php?UserName=<?php echo $result['User_ID']; ?>" class="underline font-bold" style="display:inline-block;"><?php echo $result['User_ID'] ?></a></p>
