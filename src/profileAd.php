...
?>
        ...
        <head>
            ...
            <title><?php echo $translations[$lang]['upav']; ?></title>
        ...
        <body class="bg-BrownLight w-full h-full text-BrownDark font-TextFont overflow-y-scroll custom-scrollbar">
            <div>
                ...
                <p class="md:text-5xl text-2xl font-TitleText font-bold text-center text-BrownLight bg-BrownDark py-6 mt-4 mb-2"><?php echo $translations[$lang]['uprofile']; ?></p>
            ...
            <div>
                <p class="md:text-3xl font-TitleText font-bold text-BrownLight bg-BrownDark md:px-6 md:py-6 px-4 py-4 md:mt-8 mb-2 w-fit"><?php echo $translations[$lang]['bwb']; ?>:</p>
            </div>
